...
//    int cnt;
//
//    public Product(String name, int price, int cnt, Date mfg, Date exp) {
//        this.name = name;
//        this.price = price;
...
//    }
//
//    public Product(String name, int price, String spec, int cnt, Date mfg, Date exp , String description) {
//        this.name = name;
//        this.price = price;
...
//    }
//
//    public boolean isSame(Product a){
